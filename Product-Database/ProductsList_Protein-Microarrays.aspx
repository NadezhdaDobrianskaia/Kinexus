<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ProductsList_Protein-Microarrays.aspx.cs" Inherits="ProductDB.ProductsList_Protein_Microarrays" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="style1">
        <tr>
            <td class="style4">
                <h2>
                    Product List - Protein Microarrays</h2>
            </td>
            <td class="style2">
...
">
                <SelectParameters>
                    <asp:Parameter DefaultValue="Microarray" Name="Product_Type_General" 
                        Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
            </td>
            <td>
                <asp:Button ID="Button1" runat="server" Style="margin-left: 0px" Text="Search" 
        ...
        <tr>
            <td class="style3" colspan="3">
                                ...
                                <tr style="">
                                    ...
                                    <td width="30%">
                                        <asp:HyperLink Label ID="Product_NumberLabel" runat="server" Text='<%# Eval("Product_Number") %>' 
                                            NavigateUrl='<%#"~/ProductsListDetailed_Microarray.aspx?Product_Number=" + Eval("Product_Number") %>'></asp:HyperLink>
                                    </td>
                                    <td width="60%">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Kinexus Protein ProductDBConnectionStringServer %>"
                    SelectCommand="SELECT [Product_Number], [Product_Name_Short] FROM [ProductDB] WHERE ([Product_Type_General] = @Product_Type_General) ORDER BY [Product_Type_General], [Product_Number]">
                    <SelectParameters>
