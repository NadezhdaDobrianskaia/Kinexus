<%-- ProductsList_ProteinAntibody.aspx
     @author Lili Hao --%>
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ProductsList_ProteinAntibody.aspx.cs" Inherits="ProductDB.WebForm2" %>
    ...
    <table class="style1">
        <tr>
            ...
            <div class="column nameColumn">
                    <span class="bluelable">Product Type :</span>Protein Antibodies
                </div>
            </td>
            <td class="style3">
                <asp:TextBox ID="Protein_Antibody_textbx" runat="server"></asp:TextBox>
                        ...
                        <div runat="server">
                            <table>
                                <tr style="">
                                    ...
                                    <td width="30%" class="textWite" ">
                                        <asp:HyperLink  ID="HyperLink2" runat="server" Text='<%# Eval("Product_Number") %>'
                                            NavigateUrl='<%#"~/ProductsListDetailed_ProteinAntibody.aspx?Product_Number=" + Eval("Product_Number") %>'></asp:HyperLink>
                                    </td>
                                    <td width="60%">
